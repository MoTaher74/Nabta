...
const ProductDetails = () => {
    ...
    useEffect(()=>{
        if(products.length > 0){
            ...
            productCopy = productCopy.filter((items) => product.category === items.category);
    ...
    return product && (
        <section className="mt-12">
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 mt-7 w-full ">
